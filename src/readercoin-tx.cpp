...
static void SetupReadercoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " readercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  readercoin-tx [options] <hex-tx> [commands]  Update hex-encoded readercoin transaction\n" +
            "or:     readercoin-tx [options] -create [commands]   Create hex-encoded readercoin transaction\n" +
            "\n";
