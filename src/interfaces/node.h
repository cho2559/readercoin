...
#ifndef READERCOIN_INTERFACES_NODE_H
#define READERCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a readercoin node (readercoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // READERCOIN_INTERFACES_NODE_H
