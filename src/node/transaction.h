// Copyright (c) 2017-2019 The Readercoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef READERCOIN_NODE_TRANSACTION_H
#define READERCOIN_NODE_TRANSACTION_H
...
#endif // READERCOIN_NODE_TRANSACTION_H
