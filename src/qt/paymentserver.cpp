...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("readercoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'readercoin://' is not a valid URI. Use 'readercoin:' instead."),
            CClientUIInterface::MSG_ERROR);
    }
    else if (s.startsWith(READERCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // readercoin: URI
    {
