// Copyright (c) 2012-2018 The Readercoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.readercoincore.org", "www.readercoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.readercoincore.org]", "www.readercoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.readercoincore.org:80", "www.readercoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.readercoincore.org]:80", "www.readercoincore.org", 80));
