...
"""Verify that starting readercoin with -h works as expected."""

from test_framework.test_framework import ReadercoinTestFramework
from test_framework.util import assert_equal

class HelpTest(ReadercoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start readercoin with -h for help text")
        ...
        self.log.info("Start readercoin with -version for version information")
        ...
        self.log.info("Start readercoind with -fakearg to make sure it does not start")
