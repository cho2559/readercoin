#!/usr/bin/env python3
# Copyright (c) 2015-2019 The Readercoin Core developers
...
class InvalidMessagesTest(ReadercoinTestFramework):
    ...
    def run_test(self):
        ...
        if [s for s in os.environ.get("READERCOIN_CONFIG", "").split(" ") if "--with-sanitizers" in s and "address" in s]:
